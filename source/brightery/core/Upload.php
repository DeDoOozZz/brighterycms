...
//		log_message('debug', "Upload Class Initialized");
    ...
    public function do_upload($field = 'userfile')
    {
        ...
        $this->file_name = $this->sanitize($this->file_name, true);
     ...
     * @return    array
     */
    public function data($specify = null)
    {
    ...
    {
        $CI =& get_instance();
        return $CI->security->sanitize($filename, true);
    }
    ...
    {
        $validation =& Brightery::SuperInstance()->Validation;
//		$CI->lang->load('upload');

        if (is_array($msg)) {
            foreach ($msg as $val) {
                $msg = $validation->setValidationMessage('file', $val); //($CI->lang->line($val) == FALSE) ? $val : $CI->lang->line($val);
                $this->error_msg[] = $msg;
