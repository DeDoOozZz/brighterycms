...
class Twig_Tests_TemplateTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $tests = [
            ['{{ string["a"] }}', 'Impossible to access a key ("a") on a string variable ("foo") in "%s" at line 1', false],
            ['{{ empty_array["a"] }}', 'Key "a" does not exist as the array is empty in "%s" at line 1', false],
            ['{{ array["a"] }}', 'Key "a" for array with keys "foo" does not exist in "%s" at line 1', false],
            ['{{ array_access["a"] }}', 'Key "a" in object with ArrayAccess of class "Twig_TemplateArrayAccessObject" does not exist in "%s" at line 1', false],
            ['{{ string.a }}', 'Impossible to access an attribute ("a") on a string variable ("foo") in "%s" at line 1', false],
            ['{{ string.a() }}', 'Impossible to invoke a method ("a") on a string variable ("foo") in "%s" at line 1', false],
            ['{{ empty_array.a }}', 'Key "a" does not exist as the array is empty in "%s" at line 1', false],
            ['{{ array.a }}', 'Key "a" for array with keys "foo" does not exist in "%s" at line 1', false],
            ['{{ attribute(array, -10) }}', 'Key "-10" for array with keys "foo" does not exist in "%s" at line 1', false],
            ['{{ array_access.a }}', 'Method "a" for object "Twig_TemplateArrayAccessObject" does not exist in "%s" at line 1', false],
            ['{% macro foo(obj) %}{{ obj.missing_method() }}{% endmacro %}{{ _self.foo(array_access) }}', 'Method "missing_method" for object "Twig_TemplateArrayAccessObject" does not exist in "%s" at line 1', false],
            ['{{ magic_exception.test }}', 'An exception has been thrown during the rendering of a template ("Hey! Don\'t try to isset me!") in "%s" at line 1.', false],
            ['{{ object["a"] }}', 'Impossible to access a key "a" on an object of class "stdClass" that does not implement ArrayAccess interface in "%s" at line 1', false],
        ];
    ...
    {
        $tests = [
            [new Twig_TemplatePropertyObject(), 'defined', false, false],
            [new Twig_TemplatePropertyObject(), 'defined', true, false],
            [new Twig_TemplateMethodObject(), 'defined', false, false],
            [new Twig_TemplateMethodObject(), 'defined', true, false],
        ];
    ...
    {
        $template = new Twig_TemplateTest(new Twig_Environment(null, ['strict_variables' => true]), $useExt);
    ...
    public function getGetAttributeTests()
    {
        ...
        $tests = array_merge($tests, [
            [false, null, 42, 'a', [], $anyType, false, 'Impossible to access an attribute ("a") on a integer variable ("42")'],
            [false, null, "string", 'a', [], $anyType, false, 'Impossible to access an attribute ("a") on a string variable ("string")'],
            [false, null, [], 'a', [], $anyType, false, 'Key "a" does not exist as the array is empty'],
        ]);
