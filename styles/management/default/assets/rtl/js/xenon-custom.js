        ...
        $items_with_subs.each(function (i, el) {
            ...
            $a.on('click', function (ev) {
                if (isxs()) {
                    ...
                    // Automatically will toggle other menu items in mobile views
                    if (true) {
                        sidebar_menu_close_items_siblings($li);
                    }
...
loading = {
    start: function () {
        $('body').append('<img src="' + brightery_style_images + '/loading.gif" class="brightery-loading" style="position:fixed; top:40%; bottom:40%; height:20%; left:50%; z-index:9999; "/>');
    },
    stop: function () {
        $('.brightery-loading').hide().remove();
    }
};
