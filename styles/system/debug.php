<div id="Brightery_Debugger">
    ...
    <style>
        ...
        .hljs-keyword, .hljs-id, .hljs-title, .hljs-built_in, .css .hljs-tag, .hljs-doctag, .smalltalk .hljs-class, .hljs-winutils, .bash .hljs-variable, .pf .hljs-variable, .apache .hljs-tag, .hljs-type, .hljs-typename, .tex .hljs-command, .asciidoc .hljs-strong, .markdown .hljs-strong, .hljs-request, .hljs-status, .tp .hljs-data, .tp .hljs-io {
            font-weight: bold
        }
    ...
    <script>
        $(document).ready(function () {
            $(".res-footer-menu > img, .debugger_expand").click(function () {
                $(".res-footer-menu").hide();
                $(".debug_footer").show();
                $(".debug_footer").addClass('bottom');
                $(".debug_footer").removeClass('top');
                $(".optional-details").show();
            });

            $(".optional-details").click(function () {
                $(".debug_footer").hide();
                $(".res-footer-menu").show();
            });

            $(".show-debugger-details").click(function () {
                if ($(".debug_footer").hasClass('bottom')) {
                    $(".debug_footer").addClass('top');
                    $(".debug_footer").removeClass('bottom');
                    $(".debug_wrapper").show();
                    $(".hide-optional-details").show();
                    $(".optional-details").hide();
                } else {
                    $(".debug_footer").addClass('bottom');
                    $(".debug_footer").removeClass('top');
                    $(".debug_wrapper").hide();
                    $(".hide-optional-details").hide();
                    $(".optional-details").show();
                }
            });

            $(".hide-optional-details").click(function () {
                $(".debug_footer").hide();
                $(".optional-details").hide();
                $(".res-footer-menu").show();
                $(".debug_wrapper").hide();
            ...
            $('.debug_sub_sidebar li a').click(function () {
                $('.debug_sub_sidebar li a').removeClass('active');
                $(this).addClass('active');
            });
            $('.brightery_debugger_table tbody').each(function () {
                $(this).find('tr:odd').addClass('even');
            });
            $('.brightery_debugger_table tbody').each(function () {
                $(this).find('tr:even').addClass('odd');
            });
            $('.phpinfo table tbody').each(function () {
                $(this).find('tr:odd').addClass('even');
            });
            $('.phpinfo table tbody').each(function () {
                $(this).find('tr:even').addClass('odd');
            ...
            $('.debug_toolbar pre code').each(function (i, block) {
                hljs.highlightBlock(block);
            });
        });
        function brightery_debugger(type) {
            $('.debugger_content > div').hide();
            $('.debugger_content div.brightery_debugger_' + type).show();
        }
    </script>
    ...
    <style>
        ...
        .debug_toolbar .debug_sidebar {
            width: 20%;
            float: left;
        }

        .debug_toolbar .content {
            margin-left: 22%;
        }

        .debug_toolbar .debug_sub_sidebar {
            border: 1px solid #dedede;
            margin: 0 10px;
            border-radius: 5px;
        }

        .debug_toolbar .debug_sub_sidebar a {
            display: block;
            border-bottom: 1px solid #dedede;
            padding: 13px 5px;
        }

        .debug_toolbar .debug_sub_sidebar a.active {
            background-color: #7D92CD;
            color: #fff;
            border-radius: 3px 3px 0 0;
        }

        .debug_toolbar .debug_sub_sidebar a.active:hover {
            background-color: #7D92CD;
            color: #fff;
        }

        .debug_toolbar .debug_sub_sidebar a:hover {
            background-color: #f5f5f5;
            color: #555;
        }

        .debug_toolbar .debug_footer {
            position: fixed;
            left: 0;
            right: 0;
            bottom: 0;
        ...
        .debug_toolbar .debug_footer.top {
            top: 0;
            bottom: unset;
            border-top: none;
        ...
        .debug_toolbar .debug_footer.bottom {
            bottom: 0;
            top: unset;
            border-bottom: none;
        ...
        .debug_toolbar .footer-descriptio {
            background-color: #eee;
            padding: 0 10px;
        }

        .debug_toolbar .debug_footer li {
            display: inline-block;
        }

        .debug_toolbar li.footer-logo {
            position: relative;
        }

        .debug_toolbar .sub_footer_logo img {
            width: 40px;
            left: 0;
            top: 4px;
            position: absolute;
        ...
        .debug_toolbar .debug_footer li a {
            display: inline-block;
        ...
        .debug_toolbar a.sub_footer_logo {
            margin-left: 45px;
        }

        .debug_toolbar a.sub_header_logo {
            margin-left: 45px;
        }

        .debug_toolbar span.links-title {
            font-size: 10px;
        ...
        .debug_toolbar .title-green {
            background-color: #5cb85c !important;
        }

        .debug_toolbar .title-blue {
            background-color: #3a87ad !important;
        }

        .debug_toolbar .title-bluee {
            background-color: #7D92CD !important;
        }

        .debug_toolbar .title-yellow {
            background-color: #40bbea !important;
        }

        .debug_toolbar .title-orange {
            background-color: orange !important;
        }

        .debug_toolbar .title-purple {
            background-color: #7c38bc !important;
        }

        .debug_toolbar span.optional-details {
            position: absolute;
            right: 20px;
            top: 15px;
            cursor: pointer;
        ...
        .debug_toolbar .optional-details img {
            width: 10px;
        }

        .debug_toolbar span.hide-optional-details {
            position: absolute;
            right: 20px;
            top: 15px;
            cursor: pointer;
        ...
        .debug_toolbar .hide-optional-details img {
            width: 15px;
        }

        .debug_toolbar .res-footer-menu {
            position: fixed;
            bottom: 0;
            right: 35px;
            padding: 10px 20px;
        ...
        .debug_toolbar .res-footer-menu img {
            width: 25px;
            position: absolute;
            left: 10px;
            top: 6px;
        ...
        .brightery_debugger_table,
        .phpinfo table {
            border: 1px solid #ddd;
            width: 100%;
        }

        .brightery_debugger_table thead,
        .phpinfo table thead {
            line-height: 30px;
            background-color: #f5f5f5;
        }

        .brightery_debugger_table th, .brightery_debugger_table td,
        ...
        .brightery_debugger_table .odd,
        .phpinfo table .odd {
            background-color: #fff;
        }

        .brightery_debugger_table .even,
        .phpinfo table .even {
            background-color: #f5f5f5;
        }
        ...
        .phpinfo table:first-child td a,
        .phpinfo table:first-child td h1 {
            display: inline-block;
        }
    ...
    <div class="debug_toolbar">
        ...
        <div class="debug_wrapper">
            ...
            <div class="debugger_content">
                    ...
                    <table class="brightery_debugger_table">
                        ...
                        <?php foreach ($_POST as $key => $value): ?>
                            <tr>
                                ...
                                <td>
                                    <pre><code
                                            class="php"><?php echo is_array($value) ? print_r($value, ture) : $value ?></code></pre>
                                </td>
                            </tr>
                        <?php endforeach ?>
                        </tbody>
                    ...
                    <table class="brightery_debugger_table">
                        ...
                        <?php foreach ($argv as $key => $value): ?>
                            <tr>
                                ...
                                <td>
                                    <pre><code
                                            class="php"><?php echo is_array($value) ? print_r($value, true) : $value ?></code></pre>
                                </td>
                            </tr>
                        <?php endforeach ?>
                        </tbody>
                ...
                <div style="display: none" class="brightery_debugger_configuration">
                    <h1>Configuration</h1>
                ...
                <div style="display: none" class="brightery_debugger_database">
                    <h1>Database</h1>
                    ...
                    <table class="brightery_debugger_table">
                        ...
                        <tbody>
                        <?php foreach ($db_connection as $con_key => $con_value): ?>
                            <tr>
                                <td><?php echo $con_key ?></td>
                                <td><?php echo $con_value ?></td>
                            </tr>
                        <?php endforeach ?>
                        </tbody>
                    </table>
                    ...
                    <table class="brightery_debugger_table">
                        ...
                        <?php foreach ($queries as $query): ?>
                            <tr>
                                <td><?php echo $query['execution_time'] ?></td>
                                <td>
                                    <pre><code class="sql"><?php echo $query['query'] ?></code></pre>
                                </td>
                            </tr>
                        <?php endforeach ?>
                        </tbody>
                ...
                <div style="display: none" class="brightery_debugger_assets">

                </div>
                <div style="display: none" class="brightery_debugger_mail">

                </div>
                <div style="display: none" class="brightery_debugger_log">
                    <h1>Log</h1>
