...
<div class="developer-error">
    ...
    <div class="main_error_details">
        <h2>Details</h2>

        <div class="error_details">
            <span class="error_title">Type</span>
            <span class="error_detail"><?php echo get_class($exception) ?></span>
        </div>
        <div class="error_details">
            <span class="error_title">Code</span>
            <span class="error_detail"><?= $exception->getCode() ?></span>
        </div>
        <div class="error_details">
            <span class="error_title">Message</span>
            <span class="error_detail"><?= $exception->getMessage() ?></span>
        </div>
        <div class="error_details">
            <span class="error_title">File</span>
            <span class="error_detail"><?= $exception->getFile() ?></span>
        </div>
        <div class="error_details">
            <span class="error_title">Line</span>
            <span class="error_detail">88</span>
        </div>
    </div>
    <h2 class="show_trace">Trace
        <img
            src="data:image/png;base64,">
    </h2>

    <div class="trace_errors">
        <script type="text/javascript">
            $(document).ready(function () {
                $(".show_trace").click(function () {
                    $(".trace_errors").slideToggle();
                });
